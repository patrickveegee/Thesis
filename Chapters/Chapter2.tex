...
\chapter{Haem Dioxygenase Enzymes} % Write in your own chapter title
\label{Chapter2}
\lhead{Chapter 2. \emph{Haem Dioxygenase Enzymes}} % Write in your own chapter title to set the page header


\section{Introduction to the Haem Dioxygenase Enzymes}

A previous QM/MM study on the haem dioxygenase reaction mechanism.\citep{Morokuma_TDO_ONIOM}
